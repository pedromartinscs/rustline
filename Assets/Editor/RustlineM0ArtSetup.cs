...
namespace Rustline.Editor
{
    ...
    public static class RustlineM0ArtSetup
    {
        ...
        private static Dictionary<string, PreviewAsset> CreateAnimationPreviews()
        {
            ...
            AddPreview(previews, "Backpedal", "backpedal", 8f, true);
            ...
            AddPreview(previews, "LedgeClimb", "ledge_climb", 10f, false);
            return previews;
        }
        ...
        internal static void ValidateAllOrThrow()
        {
            ...
            Dictionary<string, (int frameCount, float frameRate, bool loop, string spriteState)> clipSpecs =
                new Dictionary<string, (int frameCount, float frameRate, bool loop, string spriteState)>
                {
                    ...
                    { "Player_Body_Backpedal", (4, 8f, true, "backpedal") },
